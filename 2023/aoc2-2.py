...
class Game:
    ...
    def is_max_possible(self, max_dict: Dict[str, int]) -> bool:
        ...
        for round in self.rounds:
            for color, count in round.color_map.items():
                if max_dict[color] < count:
                    return False

        return True

    def get_min_cubes(self) -> int:
...
for line in raw_data:
    ...
    print(game.game_number)
    print(game.get_min_cubes())
    print()
    min_cube_sum += game.get_min_cubes()

print('Sum', min_cube_sum)
